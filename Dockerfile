...
#install docker
ENV DOCKER_FILE=docker-engine-17.03.0.ce-1.el7.centos.x86_64.rpm
EVN DOCKER_FILE2=docker-engine-selinux-17.03.1.ce-1.el7.centos.noarch.rpm
...
COPY ${DOCKER_FILE2} /opt/
COPY entry.sh /opt/

RUN rpm -ivh /opt/${DOCKER_FILE2} && chmod +x /opt/*.sh
